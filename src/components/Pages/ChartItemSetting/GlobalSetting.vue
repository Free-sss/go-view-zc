<template>
  ...
  <collapse-item v-if="dataZoomX" name="区域缩放(x轴)">
    <template #header>
      <n-switch v-model:value="dataZoomX.show" size="small"></n-switch>
    </template>
    <setting-item-box name="数据窗口范围">
      <setting-item name="起始百分比">
        <n-input-number v-model:value="dataZoomX.start" :min="0" :max="100" size="small"></n-input-number>
      </setting-item>
      <setting-item name="结束百分比">
        <n-input-number v-model:value="dataZoomX.end" :min="0" :max="100" size="small"></n-input-number>
      </setting-item>
    </setting-item-box>
    <setting-item-box name="基础配置">
      <setting-item name="高度">
        <n-input-number v-model:value="dataZoomX.height" :min="0" :max="30" size="small"></n-input-number>
      </setting-item>
    </setting-item-box>
  </collapse-item>
  <collapse-item v-if="dataZoomY" name="区域缩放(y轴)">
    <template #header>
      <n-switch v-model:value="dataZoomY.show" size="small"></n-switch>
    </template>
    <setting-item-box name="基础配置">
      <setting-item name="宽度">
        <n-input-number v-model:value="dataZoomY.width" :min="0" :max="30" size="small"></n-input-number>
      </setting-item>
      <setting-item name="高度">
        <n-input-number v-model:value="dataZoomY.height" :min="0" size="small"></n-input-number>
      </setting-item>
    </setting-item-box>
    <setting-item-box name="数据窗口范围">
      <setting-item name="起始百分比">
        <n-input-number v-model:value="dataZoomY.start" :min="0" :max="100" size="small"></n-input-number>
      </setting-item>
      <setting-item name="结束百分比">
        <n-input-number v-model:value="dataZoomY.end" :min="0" :max="100" size="small"></n-input-number>
      </setting-item>
    </setting-item-box>
  </collapse-item>
...
const dataZoomX = computed(() => {
  if (props.optionData.dataZoom && props.optionData.dataZoom.length > 0) {
    return props.optionData.dataZoom[0]
  } else {
    return null
  }
})

const dataZoomY = computed(() => {
  if (props.optionData.dataZoom && props.optionData.dataZoom.length > 0) {
    return props.optionData.dataZoom[1]
  } else {
    return null
  }
})
