...
import screen_scene from './screen_scene.json'
...
//根据json文件设置sessionStorage
//@ts-ignore
const { updateComponent } = useSync()
//@ts-ignore
await updateComponent(screen_scene, false, true)


await getSessionStorageInfo()
const chartEditStore = useChartEditStore() as unknown as ChartEditStorageType

console.log(chartEditStore)
// setTitle(`${chartEditStore.editCanvasConfig.projectName}`)
