...
import { TreeSelectConfig } from "./TreeSelect/index";


export default [InputsDateConfig, InputsSelectConfig, InputsTabConfig, InputsPaginationConfig, InputsInputConfig, TreeSelectConfig]
